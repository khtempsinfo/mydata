...
(function ($) {
    ...
    CRUMINA.TopSearch = function () {
        $('.js-user-search').selectize({
            ...
            searchField: ['name'],
            options: [
               {image: '/socialMediaReward/asset/app_social_media/img/avatar30-sm.jpg', name: 'Marie Claire Stevens13', message:'12 Friends in Common', icon:'olymp-happy-face-icon'},
                {image: '/socialMediaReward/asset/app_social_media/img/avatar54-sm.jpg', name: 'Marie Davidson', message:'4 Friends in Common', icon:'olymp-happy-face-icon'},
                {image: '/socialMediaReward/asset/app_social_media/img/avatar49-sm.jpg', name: 'Marina Polson', message:'Mutual Friend: Mathilda Brinker', icon:'olymp-happy-face-icon'}
            ],
            render: {
    ...
    CRUMINA.Bootstrap = function () {
		...
		var date_select_field2 = $('input[id="datetimepicker"]');
        if (date_select_field2.length) {
           var start = moment().subtract(29, 'days');

            date_select_field2.daterangepicker({
                startDate: start,
                autoUpdateInput: false,
                singleDatePicker: true,
                showDropdowns: true,
            ...
            date_select_field2.on('focus', function () {
                $(this).closest('.form-group').addClass('is-focused');
            });
            date_select_field2.on('apply.daterangepicker', function (ev, picker) {
                $(this).val(picker.startDate.format('DD-MM-YYYY'));
                $(this).closest('.form-group').addClass('is-focused');
            });
            date_select_field2.on('hide.daterangepicker', function () {
                if ('' === $(this).val()){
                    $(this).closest('.form-group').removeClass('is-focused');
                }
            });
    ...
    $document.on('click', function (event) {
		if (!$(event.target).closest('.chat-setting-list')){	
